...
const BlogDetail = () => {
  ...
  const isCustomPage = blog.layoutMode === "custom-page";
        ...
        <div className="w-full">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 mb-8 flex items-center justify-between border-b border-white/10 pb-4 flex-wrap gap-4">
            ...
            <div className="flex items-center gap-3">
              <span className="px-3 py-1 rounded-lg text-xs font-semibold bg-primary text-white shadow-md">
                {blog.category}
              </span>
              <button
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-white/50">{formatDate(blog.createdAt)}</div>
                </div>
              </div>
              <Link
                to="/blogs"
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl border border-white/15 bg-secondary-navy/40 hover:border-primary/50 text-white font-semibold text-xs transition"
              >

      ...
      <div className="bg-main-bg text-white min-h-screen">
        ...
        <section className="relative pt-40 pb-20 px-6 overflow-hidden flex items-center justify-center min-h-[60vh]">
          ...
          <div className="relative z-10 max-w-7xl mx-auto sm:px-6 px-4 text-left space-y-6">
            ...
            >
              About Neffto Solution - A Software House in Bahawalpur
            </motion.h1>
            <motion.h2
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.1 }}
              className="text-2xl md:text-3xl font-bold text-primary uppercase tracking-wide"
            >
              About Us
            </motion.h2>
            <motion.p
            ...
            >
              Neffto Solution is a premier digital agency focused on delivering
              cutting-edge technology and design. We build digital experiences
          ...
          <div className="max-w-7xl mx-auto sm:px-6 px-4 grid md:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-zinc-300 leading-relaxed text-lg">
                We believe in the power of innovation. Our mission is to
                transform ideas into robust digital solutions that empower
                businesses to thrive in a competitive landscape.
              </p>
              
              <h2 className="text-3xl md:text-4xl font-bold tracking-wide pt-6">
                How We Work
              </h2>
              <p className="text-zinc-300 leading-relaxed text-lg">
                Through a combination of strategic thinking, creative design, and
                technical excellence, we help our clients achieve their highest
                potential.
              </p>
              ...
              <p className="text-zinc-300 leading-relaxed text-lg">
                Whether it is web development, mobile apps, or digital
                marketing, our team of experts is dedicated to delivering

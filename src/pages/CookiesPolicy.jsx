        ...
        <div className="max-w-4xl mx-auto sm:px-6 px-4 pb-16 relative z-20 mt-10">
          <main className="bg-surface/30 p-6 sm:p-10 rounded-2xl border border-white/10 shadow-md backdrop-blur-md">
            ...
            <p className="mb-4 leading-relaxed text-zinc-300">
              ...
              your personal data secure, see our Privacy Policy, if and when We
              make it available within the Website or on our website.
            </p>
            ...
            <section className="mb-10">
              ...
              <ul className="space-y-3 pl-2 mb-6 text-zinc-300">
                <li className="relative pl-6 before:content-[''] before:absolute before:left-0 before:top-2.5 before:w-2 before:h-2 before:bg-primary before:rounded-full">
                  ...
                  &quot;Us&quot; or &quot;Our&quot; in this Cookies Policy)
                  refers to Neffto Solution.
                </li>
                <li className="relative pl-6 before:content-[''] before:absolute before:left-0 before:top-2.5 before:w-2 before:h-2 before:bg-primary before:rounded-full">
                  <strong className="text-white">Cookies</strong> means small
                  files that are placed on Your computer, mobile device or any
                  other device by a website, containing details of your browsing
                  history on that website among its many uses.
                </li>
                <li className="relative pl-6 before:content-[''] before:absolute before:left-0 before:top-2.5 before:w-2 before:h-2 before:bg-primary before:rounded-full">
                  <strong className="text-white">Website</strong> refers to
                  Neffto Solution, accessible from{" "}
                  <a
                ...
                <li className="relative pl-6 before:content-[''] before:absolute before:left-0 before:top-2.5 before:w-2 before:h-2 before:bg-primary before:rounded-full">
                  ...
                  individual accessing or using the Website, or a company, or
                  any legal entity on behalf of which such individual is
            ...
            <section className="mb-10">
              ...
              <p className="mb-4 leading-relaxed text-zinc-300">
                ...
                Cookies that are not strictly necessary. Strictly necessary
                Cookies are used to provide the Website and cannot be switched
                off in our systems.
              </p>
              <p className="mb-4 leading-relaxed text-zinc-300">
            ...
            <section className="mb-10">
              ...
              <p className="mb-4 leading-relaxed text-zinc-300">
                ...
                delete the Cookies saved in your browser associated with the
              ...
              <ul className="space-y-3 pl-2 mb-6 text-zinc-300">
                <li className="relative pl-6 before:content-[''] before:absolute before:left-0 before:top-2.5 before:w-2 before:h-2 before:bg-primary before:rounded-full">
                  ...
                  <a
                    ...
                    rel="noreferrer"
                    target="_blank"
                    className="text-primary hover:text-white underline underline-offset-2 break-all"
                  >
                    https://support.google.com/accounts/answer/32050
                  </a>
                </li>
                <li className="relative pl-6 before:content-[''] before:absolute before:left-0 before:top-2.5 before:w-2 before:h-2 before:bg-primary before:rounded-full">
                  For the Microsoft Edge browser, please visit this page from
                  Microsoft:{" "}
                  <a

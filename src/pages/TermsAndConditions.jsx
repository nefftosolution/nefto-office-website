...
const TermsAndConditions = () => {
  return (
    <>
      <SEO title="Terms and Conditions" description="Terms and Conditions for Neffto Solutions" />
        ...
        <div className="max-w-4xl mx-auto sm:px-6 px-4 pb-16 relative z-20 mt-10">
          <main className="bg-surface/30 p-6 sm:p-10 rounded-2xl border border-white/10 shadow-md backdrop-blur-md">
            ...
            <section className="mb-10">
              ...
              <p className="mb-4 text-zinc-300">For the purposes of these Terms and Conditions:</p>
              <ul className="space-y-3 pl-2 mb-6 text-zinc-300">
                ...
                <li className="relative pl-6 before:content-[''] before:absolute before:left-0 before:top-2.5 before:w-2 before:h-2 before:bg-primary before:rounded-full">
                  <strong className="text-white">Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in these Terms and Conditions) refers to Neffto Solution, Faisal Colony, Bahawalpur Pakistan.
                </li>
                <li className="relative pl-6 before:content-[''] before:absolute before:left-0 before:top-2.5 before:w-2 before:h-2 before:bg-primary before:rounded-full">
                ...
                <li className="relative pl-6 before:content-[''] before:absolute before:left-0 before:top-2.5 before:w-2 before:h-2 before:bg-primary before:rounded-full">
                  <strong className="text-white">Website</strong> refers to Neffto Solution, accessible from <a href="https://nefftosolution.com/" rel="noreferrer" target="_blank" className="text-primary hover:text-white underline underline-offset-2">https://nefftosolution.com/</a>
                </li>
                <li className="relative pl-6 before:content-[''] before:absolute before:left-0 before:top-2.5 before:w-2 before:h-2 before:bg-primary before:rounded-full">
            ...
            <section className="mb-10">
              <h2 className="text-2xl font-bold text-white mb-4 pb-2 border-b-2 border-white/10">Acknowledgment</h2>
              <p className="mb-4 leading-relaxed text-zinc-300">
            ...
            <section className="mb-10">
              <h2 className="text-2xl font-bold text-white mb-4 pb-2 border-b-2 border-white/10">Links to Other Websites</h2>
              <p className="mb-4 leading-relaxed text-zinc-300">
              ...
              <h3 className="text-xl font-semibold text-primary mt-6 mb-3">Links from a Third-Party Social Media Service</h3>
              <p className="mb-4 leading-relaxed text-zinc-300">
            ...
            <section className="mb-10">
              <h2 className="text-2xl font-bold text-white mb-4 pb-2 border-b-2 border-white/10">Termination</h2>
              <p className="mb-4 leading-relaxed text-zinc-300">
            ...
            <section className="mb-10">
              <h2 className="text-2xl font-bold text-white mb-4 pb-2 border-b-2 border-white/10">Limitation of Liability</h2>
              <p className="mb-4 leading-relaxed text-zinc-300">
            ...
            <section className="mb-10">
              <h2 className="text-2xl font-bold text-white mb-4 pb-2 border-b-2 border-white/10">&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h2>
              <p className="mb-4 leading-relaxed text-zinc-300">
            ...
            <section className="mb-10">
              <h2 className="text-2xl font-bold text-white mb-4 pb-2 border-b-2 border-white/10">Governing Law</h2>
              <p className="mb-4 leading-relaxed text-zinc-300">
            ...
            <section className="mb-10">
              <h2 className="text-2xl font-bold text-white mb-4 pb-2 border-b-2 border-white/10">Disputes Resolution</h2>
              <p className="mb-4 leading-relaxed text-zinc-300">
            ...
            <section className="mb-10">
              <h2 className="text-2xl font-bold text-white mb-4 pb-2 border-b-2 border-white/10">For European Union (EU) Users</h2>
              <p className="mb-4 leading-relaxed text-zinc-300">
            ...
            <section className="mb-10">
              <h2 className="text-2xl font-bold text-white mb-4 pb-2 border-b-2 border-white/10">United States Legal Compliance</h2>
              <p className="mb-4 leading-relaxed text-zinc-300">
            ...
            <section className="mb-10">
              <h2 className="text-2xl font-bold text-white mb-4 pb-2 border-b-2 border-white/10">Severability and Waiver</h2>
              
              <h3 className="text-xl font-semibold text-primary mt-6 mb-3">Severability</h3>
              <p className="mb-4 leading-relaxed text-zinc-300">
                If any provision of these Terms is held to be unenforceable or invalid, such provision will be changed and interpreted to accomplish the objectives of such provision to the greatest extent possible under applicable law and the remaining provisions will continue in full force and effect.
              </p>

              <h3 className="text-xl font-semibold text-primary mt-6 mb-3">Waiver</h3>
              <p className="mb-4 leading-relaxed text-zinc-300">
            ...
            <section className="mb-10">
              <h2 className="text-2xl font-bold text-white mb-4 pb-2 border-b-2 border-white/10">Translation Interpretation</h2>
              <p className="mb-4 leading-relaxed text-zinc-300">
            ...
            <section className="mb-10">
              <h2 className="text-2xl font-bold text-white mb-4 pb-2 border-b-2 border-white/10">Changes to These Terms and Conditions</h2>
              <p className="mb-4 leading-relaxed text-zinc-300">
            ...
            <section className="mt-12 bg-surface/50 border border-white/10 text-white p-8 rounded-2xl">
              ...
              <p className="mb-4 text-zinc-300">If you have any questions about these Terms and Conditions, You can contact us:</p>

...
const Disclaimer = () => {
  return (
    <>
      <SEO title="Disclaimer" description="Disclaimer for Neffto Solutions" />
      <div className="bg-main-bg text-white sm:pt-40 pt-30 sm:pb-20 pb-10">
        <div className="max-w-7xl mx-auto sm:px-6 px-4 space-y-6 bg-surface/30 p-8 rounded-2xl border border-white/10 backdrop-blur-md">
          <h1 className="text-4xl font-bold text-off-white mb-6">Disclaimer for Neffto Solutions</h1>
          ...
          <h2 className="text-2xl font-semibold text-primary mt-8 mb-4">Disclaimers for Neffto Solutions</h2>
          
          <p className="text-zinc-300 leading-relaxed mb-4">
            All the information on this website - <strong>nefftosolution@gmail.com</strong> - is published in good faith and for general information purpose only. <strong>Neffto Solutions</strong> does not make any warranties about the completeness, reliability and accuracy of this information. Any action you take upon the information you find on this website (<strong>Neffto Solutions</strong>), is strictly at your own risk. <strong>Neffto Solutions</strong> will not be liable for any losses and/or damages in connection with the use of our website.
          </p>
